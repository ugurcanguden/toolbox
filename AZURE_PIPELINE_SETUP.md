...
| `SERVER_PORT` | `3000` | ❌ | Server'da expose edilen port |
| `NEXT_PUBLIC_SITE_URL` | `http://your-domain.com` | ❌ | Uygulamanın public URL'i |
...
- `SERVER_PORT`: `3001`
- `NEXT_PUBLIC_SITE_URL`: `http://staging.your-domain.com`

### `toolbox-uat`
- `ENVIRONMENT`: `uat`
- `SSH_HOST`: `<uat-server-ip>`
- `SERVER_PORT`: `3002`
- `NEXT_PUBLIC_SITE_URL`: `http://uat.your-domain.com`
...
```bash
# HTTP status kontrol
curl -I http://164.92.135.142:3000

# Detailed response
curl http://164.92.135.142:3000
```
